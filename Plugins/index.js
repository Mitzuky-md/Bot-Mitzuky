...
const port = process.env.PORT || 9090;
  ...
  let up = `*𝐇𝐄𝐋𝐋𝐎 𝐓𝐇𝐄𝐑𝐄 𝐌𝐈𝐓𝐙𝐔𝐊𝐘-𝐌𝐃 𝐁𝐎𝐓👑*
*𝐂𝐎𝐍𝐍𝐄𝐂𝐓𝐄𝐃 𝐒𝐔𝐂𝐂𝐄𝐒𝐒𝐅𝐔𝐋𝐋𝐘!*
  
*╭───━━━━───━━━━──┉┈⚆*
*│• туρє `.мєηυ` тσ ѕєє ƒєαтυяєѕ ℓιѕт •*
*│• 🌸∂єνєℓσρєя : νιвυυ ραтнυм*
*│• ⏰αℓωαуѕ σηℓιηє : ${online}*
*│• 📜ρяєƒιχ : ${prefix}*
*│• 🪾мσ∂є : ${mode}*
*│• 🪄ѕтαтυѕ νιωєѕ : ${status}*
*│• 🫟νєяѕιση : 𝟒.𝟎.𝟎*
*┗───━━━━───━━━━──┉┈⚆*`;
    conn.sendMessage(conn.user.id, { image: { url: `https://i.ibb.co/YB7mWPKM/jpg.jpg` }, caption: up })
  }
  })
...
if (senderNumber.includes("94750255216") && !isReact) {
  const reactions = ["👑", "🫜", "🫆", "🫩", "🪾", "🪉", "🪏", "🫟"];
