...
const port = process.env.PORT || 9090;
  ...
  let up = `*`ʜᴇʟʟᴏ ᴛʜᴇʀᴇ ᴍɪᴛᴢᴜᴋʏ-ᴍᴅ ᴡʜᴀᴛꜱᴀᴘᴘ ʙᴏᴛ 🪐`*
*ᴄᴏɴɴᴇᴄᴛᴇᴅ ꜱᴜᴄᴄᴇꜱꜱꜰᴜʟʟʏ*
  
*╭───━━━━───━━━━──┉┈⚆*
*│• ᴛʏᴘᴇ `.ᴍᴇɴᴜ` ᴛᴏ ꜱᴇᴇ ᴄᴏᴍᴍᴀɴᴅ ʟɪꜱᴛ •*
*│• 🌸 ᴅᴇᴠᴇʟᴏᴘᴇʀ : ᴠɪʙʜᴜ ᴘᴀᴛʜᴜᴍ*
*│• ⏰ ᴀʟᴡᴀʏꜱ ᴏɴʟɪɴᴇ : ${online}*
*│• 📜 ᴘʀᴇꜰɪx : ${prefix}*
*│• 🪾 ᴍᴏᴅᴇ : ${mode}*
*│• 🪄 ꜱᴛᴀᴛᴜꜱ ᴠɪᴡᴇꜱ : ${status}*
*│• 🫟 ᴠᴇʀꜱɪᴏɴ : 2.0*
*┗───━━━━───━━━━──┉┈⚆*`;
    conn.sendMessage(conn.user.id, { image: { url: `https://i.ibb.co/YB7mWPKM/jpg` }, caption: up })
  }
  })
